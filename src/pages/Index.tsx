...
const Index = () => {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-background px-4">
      {/* Social proof badge */}
      <div className="mb-8 flex items-center gap-3 rounded-full border border-border/60 bg-secondary/50 px-5 py-2.5 shadow-sm">
        {/* Logos */}
        ...
        {/* User count */}
        <span className="text-sm font-medium text-muted-foreground">35,000+ users</span>
      </div>
